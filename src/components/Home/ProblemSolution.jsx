...
export default function ProblemSolution() {
  ...
  // Changed initial lost revenue from 14250 to 600
  const [lostRevenue, setLostRevenue] = useState(600); 
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      setProgress((prev) => {
        ...
        if (nextProgress <= 0) {
          // Reset loop and add lost revenue (increases by 8)
          setLostRevenue((curr) => curr + 8);
          setPhase(1);
          return 100;
        }
