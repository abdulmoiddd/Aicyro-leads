    ...
    <main className="relative z-10 flex-grow w-full max-w-[1600px] mx-auto px-4 sm:px-8 py-6 flex flex-col h-full min-h-[calc(100vh-100px)] fade-in">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-6 shrink-0">
        ...
        {onLogout && (
          <button
            onClick={onLogout}
            className="text-xs font-bold uppercase tracking-wider bg-[var(--background)] hover:bg-red-500/10 text-[var(--foreground-muted)] hover:text-red-400 border border-[var(--border-color)] hover:border-red-500/30 px-5 py-2.5 rounded-lg transition-all"
          >
            Sign Out
          </button>
        )}
