...
export default function LeadScreen({ onLogout }) {
  ...
  const filteredLeads = leads.filter((lead) => {
    ...
    // --- UPDATED: Now searches by Reference ID (lead.id) as well ---
    const matchesSearch =
        ...
        <div className="px-6 py-4 border-b border-[var(--border-color)] bg-[var(--background)]/30 flex flex-col xl:flex-row gap-4 justify-between items-center">
          ...
          <div className="flex w-full xl:w-auto items-center gap-3">
            <select
              ...
              className="bg-[var(--background)] border border-[var(--border-color)] rounded-lg px-3 py-2 text-sm text-[var(--foreground)] focus:outline-none focus:border-[var(--primary)] transition-colors cursor-pointer outline-none"
            >
            ...
            <button
              onClick={fetchLeads}
              className="p-2 border border-[var(--border-color)] bg-[var(--background)] rounded-lg text-[var(--foreground-muted)] hover:text-[var(--foreground)] hover:border-[var(--foreground-muted)] transition-colors"
            >
              <svg
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        {/* --- UPDATED: Reference ID displayed beside the name --- */}
